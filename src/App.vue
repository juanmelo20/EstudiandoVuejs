...
const desactivarAdd = computed(()=>{
      const numSearch = arraysAgregados.value.find(num => num === contador.value)
     /* if(numSearch===0){
            return true
      }
...
const Add=()=>{
      arraysAgregados.value.push(contador.value)   
}
</script>
